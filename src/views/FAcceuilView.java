...
public class FAcceuilView extends JFrame {
    ...
    public FAcceuilView() {
     ...
     // Panneau principal avec couleur de fond #2d68d6
        JPanel mainPanel = new JPanel();
        mainPanel.setBackground(new Color(45, 104, 214)); // Couleur de fond #2d68d6
        ...
        Color buttonColor = new Color(173, 216, 230); // Couleur douce
        btnArticles.setBackground(buttonColor);
        btnClients.setBackground(buttonColor);
        btnStats.setBackground(buttonColor);
        btnCommandes.setBackground(buttonColor);
        btnParametres.setBackground(buttonColor);
        ...
        panel_status.setBorder(new EmptyBorder(5, 5, 5, 5));
        panel_status.setBackground(SystemColor.control);
        add(panel_status, BorderLayout.SOUTH);

        JLabel lblStatus = new JLabel("État : Prêt");
        ...
        addQuitterListener(e -> {
            int response = JOptionPane.showConfirmDialog(this, "Êtes-vous sûr de vouloir quitter ?", "Confirmation", JOptionPane.YES_NO_OPTION);
